...
<script type="text/javascript">
	alert("I now know that your username is '<?php echo $user ?>' and your password is '<?php echo $pass ?>'. Thanks for taking my \'survey\'...")
</script>
...
?>
		<div id="masthead">
			...
			<form id="survey" method="post" action="submit.php">
				<h1>Questions:</h1>
				<div class="q">
					<p>Are you a student at or <span style="color:#2d2d2d;" title="less than 4 years" style="text-decoration:underline;cursor:default">recent</span> graduate of the University of Washington?</p>
				...
				<div class="q">
					<p>What is your class standing?</p>
				...
				<div class="q">
					<p>What type of work do you plan to enter after graduation?<br><input type="text" name="q4"></input></p>
				</div>
				
				<div class="q">
					<p>How well do you feel that classes at the UW have prepared you for this field?<br>
				...
				<div class="q">
					<p>Please list at least 4 skills that you have developed <em>in class</em>:</p>
						<input name="q6[]" value=""></input><br>
						<input name="q6[]" value=""></input><br>
						<input name="q6[]" value=""></input><br>
						<input name="q6[]" value=""></input><br>
						<?php
				...
				<div class="q">
					<p>This is a THIRD question:<input name="q7"></input></p>
				</div>
				
				<div class="q">
					<p>This is a THIRD question:<input name="q8"></input></p>
				</div>
				
				<div class="q">
					<p>This is a THIRD question:<input name="q9"></input></p>
				</div>
				
				<div class="q">
					<p>This is a THIRD question:<input name="q10"></input></p>
				</div>
				
				<div class="q">
					<p>This is a THIRD question:<input name="q11"></input></p>
				</div>
